...
function BookDetails() {
  ...
  const inputStyle = {
    ...
    marginBottom: '16px', backgroundColor: '#faf5ff', color: '#3b0764',
    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'Georgia', serif", backgroundColor: '#f4f1fb' }}>
      ...
      <div style={{ flex: 1, padding: '28px', overflowY: 'auto' }}>
        ...
        <div style={{
          ...
          padding: '28px 30px', maxWidth: '600px',
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ color: '#c4b5fd', fontSize: '11px', marginTop: '2px' }}>
                {isNew ? 'Fill in the details below' : 'Update the details below'}
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end', marginTop: '4px' }}>
            <button
              ...
              style={{
                padding: '10px 22px', backgroundColor: 'white', color: '#7c3aed',
                border: '1.5px solid #ddd6fe', borderRadius: '8px', cursor: 'pointer',
                fontWeight: '700', fontSize: '13px', transition: 'all 0.2s',
              }}
              onMouseEnter={e => { e.currentTarget.style.backgroundColor = '#f3f0ff'; e.currentTarget.style.borderColor = '#7c3aed'; }}
            ...
            <button
              ...
              style={{
                padding: '10px 22px',
                background: saving ? '#e5e7eb' : 'linear-gradient(135deg, #5b21b6, #4f46e5)',
                color: saving ? '#9ca3af' : 'white',
                border: 'none', borderRadius: '8px', cursor: saving ? 'default' : 'pointer',
                fontWeight: '700', fontSize: '13px',
                boxShadow: saving ? 'none' : '0 2px 8px rgba(91,33,182,0.25)',
